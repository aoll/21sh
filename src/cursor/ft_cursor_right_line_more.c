...
/*   Updated: 2017/03/15 17:25:39 by alex             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_cursor_right_line_more_end(
...
static int	ft_cursor_right_line_more_init_index(
	t_cursor *cursor, t_arr *arr,
	int *index_end_showed, int *index_start_showed)
{
...
int	ft_cursor_right_line_more(t_cursor *cursor, t_arr *arr)
{
	...
	{
		ft_cursor_right_line_more_end(cursor, arr, ptr_tmp, index_end_showed);
	}
